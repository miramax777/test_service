...
public class ServiceCClient {
    ...
    public SkinIssues getSessionIssuesById(final Long sessionId) {
        ...
        ResponseEntity<SkinIssues> response = null;

        try {
            // Long response time up to 3 seconds
            response = restTemplate.exchange("http://api.flix-tech.test", GET, requestEntity, SkinIssues.class);
